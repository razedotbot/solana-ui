...
export const ConsolidatePanel: React.FC<ConsolidatePanelProps> = ({
  ...
  useEffect(() => {
    if (useExternalSource && currentStep === 0) {
      const sourceAddresses = wallets
        .filter((w) => selectedWalletIds.has(w.id))
        .map((w) => w.address);
      setSelectedSourceWallets(sourceAddresses);
    }
  ...
  const handleConsolidate = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      const receiverPrivateKey = getPrivateKeyByAddress(
      ...
      showToast(
        "Consolidation failed: " + (errorMessage || "Unknown error"),
        "error",
      );
    } finally {
      setIsSubmitting(false);
  ...
  const handleSelectAllSources = (): void => {
    if (selectedSourceWallets.length === getAvailableSourceWallets().length) {
      ...
      setSelectedSourceWallets(
        getAvailableSourceWallets().map((wallet) => wallet.address),
      );
    }
  };
                  ...
                  <div className="group">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-sm font-medium text-app-secondary group-hover:color-primary transition-colors duration-200 font-mono uppercase tracking-wider">
                        <span className="color-primary">&#62;</span> Recipient
                        Wallet <span className="color-primary">&#60;</span>
                      </label>
                      {selectedRecipientWallet && (
                    ...
                    <div className="h-52 overflow-y-auto border border-app-primary-20 rounded-lg shadow-inner bg-app-tertiary transition-all duration-200 group-hover:border-app-primary-40 scrollbar-thin">
                      {filterWallets(
                        getAvailableRecipientWalletsForConsolidate(),
                        recipientSearchTerm,
                      ).length > 0 ? (
                        filterWallets(
                          getAvailableRecipientWalletsForConsolidate(),
                          ...
                          <div
                            ...
                            onClick={() =>
                              setSelectedRecipientWallet(wallet.address)
                            }
                          >
                            <div
                  ...
                  <div className="group">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-sm font-medium text-app-secondary group-hover:color-primary transition-colors duration-200 font-mono uppercase tracking-wider">
                        ...
                        Wallets <span className="color-primary">&#60;</span>
                      </label>
                      <button
                      ...
                      >
                        {selectedSourceWallets.length ===
                        getAvailableSourceWallets().length
                          ? "DESELECT ALL"
                          : "SELECT ALL"}
                      </button>
                    </div>
                        ...
                        filterWallets(
                          ...
                          return (
                            <div
                              ...
                              onClick={() =>
                                toggleSourceWalletSelection(wallet.address)
                              }
                            >
                              <div
                                className={`w-5 h-5 mr-3 rounded flex items-center justify-center transition-all duration-300
                      ...
                      <div className="bg-app-tertiary rounded-lg p-3 border border-app-primary-30 h-full shadow-inner">
                        <div className="flex items-center justify-between mb-2">
                          <h3 className="text-sm font-semibold text-app-primary font-mono tracking-wider">
                            <span className="color-primary">//</span> LIVE
                            PREVIEW
                          </h3>
                          {amount && (
                          ...
                          <div className="flex flex-col space-y-1">
                            <div className="flex justify-between items-center">
                              ...
                              <span className="text-xs text-app-primary font-mono">
                                {selectedSourceWallets.length} SELECTED
                              </span>
                            </div>
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <span className="text-xs text-app-primary font-mono">
                                {formatAddress(selectedRecipientWallet)}
                              </span>
                            </div>
            ...
            <div className="flex flex-col space-y-4 animate-[fadeIn_0.3s_ease]">
              ...
              <div className="w-full space-y-4">
                <div className="bg-app-tertiary rounded-lg p-4 border border-app-primary-30 shadow-inner">
                  <h3 className="text-base font-semibold text-app-primary mb-3 font-mono tracking-wider">
                    <span className="color-primary">//</span> CONSOLIDATION
                    SUMMARY
                  </h3>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center bg-app-secondary px-2 py-1 rounded border border-app-primary-20">
                        <span className="text-sm font-mono text-app-primary glitch-text">
                          {getWalletByAddress(selectedRecipientWallet)
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm text-app-primary font-mono">
                        {selectedSourceWallets.length} WALLETS
                      </span>
                    </div>
              ...
              <div className="w-full">
                <div className="bg-app-tertiary rounded-lg p-4 border border-app-primary-30 h-full shadow-inner">
                  <h3 className="text-base font-semibold text-app-primary mb-3 font-mono tracking-wider">
                    <span className="color-primary">//</span> SELECTED SOURCE
                    WALLETS
                  </h3>
