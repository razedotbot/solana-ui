...
export const DepositPanel: React.FC<DepositPanelProps> = ({
  ...
  const modalContent = (
    <div className={inline ? "relative flex flex-col h-full overflow-hidden" : "relative bg-app-primary border border-app-primary-40 rounded-lg shadow-lg w-full max-w-md overflow-hidden transform modal-content"}>
              ...
              <div>
                ...
                {publicKey && (
                  <div className="mt-3 p-3 bg-app-tertiary rounded-lg border border-app-primary-30 text-sm font-mono text-app-primary break-all shadow-inner animate-[fadeIn_0.3s_ease]">
                    <div className="text-xs text-app-secondary mb-1 font-mono uppercase">
                      Connected:
                    </div>
                    {publicKey}
                  </div>
              ...
              <div className="group mt-5">
                <div className="flex items-center justify-between mb-2">
                  <label className="text-sm font-medium text-app-secondary group-hover:color-primary transition-colors duration-200 font-mono uppercase tracking-wider">
                    <span className="color-primary">&#62;</span> Select
                    Recipient <span className="color-primary">&#60;</span>
                  </label>
                  {selectedWallet && (
