...
export const QuickTradeModal: React.FC<QuickTradeModalProps> = ({
  ...
  const [selectedCategory, setSelectedCategory] =
    useState<WalletCategory>("Medium");
  const [tempSettings, setTempSettings] =
    useState<Record<WalletCategory, CategoryQuickTradeSettings>>(
      categorySettings,
    );
            ...
            <div className="bg-app-quaternary border border-app-primary-20 rounded-lg p-4">
              ...
              <div className="flex items-center gap-3 mb-4 p-3 bg-app-primary border border-app-primary-30 rounded-lg">
                <div className="flex-1">
                  <div className="font-mono color-primary text-sm mb-1">
                    Amount Type
                  </div>
                  <p className="text-xs text-app-secondary-80">
                    {currentSettings.useBuyRange
                      ? "Random amounts for natural variation"
                      : "Fixed amount for consistency"}
                  </p>
                </div>
              ...
              {currentSettings.useBuyRange ? (
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-sm font-mono color-primary mb-2 flex items-center gap-1">
                        <span>Min Amount</span>
                        <span className="text-app-secondary-80 text-xs">
                          (SOL)
                        </span>
                      </label>
                      <input
                  ...
                  <div className="bg-app-primary border border-app-primary-20 rounded-lg p-3">
                    ...
                    <p className="text-xs text-app-secondary-80">
                      Each quick buy will randomly spend between{" "}
                      <span className="color-primary font-mono">
                        {currentSettings.buyMinAmount.toFixed(3)}
                      </span>{" "}
                      and{" "}
                      <span className="color-primary font-mono">
                        {currentSettings.buyMaxAmount.toFixed(3)}
                      </span>{" "}
                      SOL
                    </p>
                  </div>
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-app-secondary-80">
                  {currentSettings.useSellRange
                    ? "Random percentages for natural variation"
            ...
            {currentSettings.useSellRange ? (
              <div className="space-y-4">
                ...
                <div className="bg-app-primary border border-app-primary-30 rounded-lg p-3">
                  <p className="text-xs text-app-secondary-80">
                    Each quick sell will randomly sell between{" "}
                    <span className="color-primary font-mono">
                      {currentSettings.sellMinPercentage}%
                    </span>{" "}
                    and{" "}
                    <span className="color-primary font-mono">
                      {currentSettings.sellMaxPercentage}%
                    </span>{" "}
                    of token balance
                  </p>
                </div>
