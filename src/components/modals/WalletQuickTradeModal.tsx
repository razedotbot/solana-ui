        ...
        <div className="flex justify-between items-center mb-6 pb-4 border-b border-app-primary-20">
          <div>
            ...
            <p className="text-xs text-app-secondary-80 mt-1 font-mono">
              {wallet.label || wallet.address.substring(0, 8)}... • Category:{" "}
              {category}
            </p>
          </div>
          <button
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div
                  className="w-11 h-6 bg-app-tertiary peer-focus:outline-none rounded-full peer
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (
                            !isNaN(value) &&
                            value > (tempSettings.buyMinAmount || 0) &&
                            value <= 10
                          ) {
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (!isNaN(value) && value >= 1 && value <= 100) {
                            ...
                            if (
                              value >= (tempSettings.sellMaxPercentage || 0)
                            ) {
                              updateSetting(
                                "sellMaxPercentage",
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (
                            !isNaN(value) &&
                            value > (tempSettings.sellMinPercentage || 0) &&
                            value <= 100
                          ) {
