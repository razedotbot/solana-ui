...
export const PnlModal: React.FC<PnlModalProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-app-primary-85">
      <div className="relative bg-app-primary border border-app-primary-40 rounded-lg shadow-lg w-full max-w-2xl mx-4 overflow-hidden transform modal-content modal-glow">
