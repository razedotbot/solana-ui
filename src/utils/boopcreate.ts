...
const getPartiallyPreparedTransactions = async (
  ...
  try {
    ...
    const data = await response.json() as BoopCreateResponse;
 ...
 */
const sendFirstBundle = async (bundle: BoopCreateBundle): Promise<{success: boolean, result?: BundleResult, error?: string}> => {
